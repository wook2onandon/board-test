...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState({
    ...
    "packageRegistryData": [
      [null, [
        [null, {
          ...
          "packageDependencies": [
            ...
            ["typescript", "patch:typescript@npm%3A5.0.2#~builtin<compat/typescript>::version=5.0.2&hash=493e53"]
          ],
          "linkType": "SOFT",
        }]
      ]],
      ...
      ["typescript", [
        ["patch:typescript@npm%3A5.0.2#~builtin<compat/typescript>::version=5.0.2&hash=493e53", {
          "packageLocation": "./.yarn/cache/typescript-patch-efc1d1b96b-bdbf3d0aac.zip/node_modules/typescript/",
          "packageDependencies": [
            ["typescript", "patch:typescript@npm%3A5.0.2#~builtin<compat/typescript>::version=5.0.2&hash=493e53"]
          ],
          "linkType": "HARD",
